...
static class Settings
{
	...
	public static void CopyCommonDLLs(Project.Configuration conf, Target target)
	{
		...
		conf.TargetCopyFilesToSubDirectory.Add(new KeyValuePair<string, string>(
				@"[project.SharpmakeCsPath]/lib/D3D12AgilitySDK/D3D12SDKLayers.dll", "D3D12")
		);
		...
		{
			conf.TargetCopyFilesToSubDirectory.Add(new KeyValuePair<string, string>(
					@"[project.SharpmakeCsPath]/lib/D3D12AgilitySDK/D3D12Core.pdb", "D3D12")
			);
			conf.TargetCopyFilesToSubDirectory.Add(new KeyValuePair<string, string>(
					@"[project.SharpmakeCsPath]/lib/D3D12AgilitySDK/D3D12SDKLayers.pdb", "D3D12")
			);
		}
	}
}
...
class HelloTriangleProject : BaseProject
{
	...
	public override void ConfigureAll(Project.Configuration conf, Target target)
	{
		...
		Settings.CopyCommonDLLs(conf, target);
