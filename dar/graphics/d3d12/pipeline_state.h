...
struct PipelineStateDesc {
	String shaderName = ""; ///< Base name of the shader files
	...
	D3D12_STATIC_SAMPLER_DESC *staticSamplerDescs = nullptr; ///< Static sampler description. Used for root signature creation
