...
bool DepthBuffer::init(ComPtr<ID3D12Device> device, int width, int height, DXGI_FORMAT format, const String &name) {
	...
	depthTex.init(resData, TextureResourceType::DepthStencil, name);
