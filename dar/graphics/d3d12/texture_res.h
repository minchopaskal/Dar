...
struct TextureResource {
	...
	bool init(TextureInitData &initData, TextureResourceType type, const String &name, Optional<HeapHandle> heapInfo = std::nullopt);
	...
	UINT64 upload(UploadHandle uploadHandle, ImageData &imgData);
